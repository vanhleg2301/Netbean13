<%-- 
    Document   : manager
    Created on : Oct 24, 2022, 1:54:48 PM
    Author     : Admin
--%>
                ...
                <tbody>
                    <c:forEach items="${requestScope.listM}" var="c">
                        <tr>
                            <td>${c.id}</td>
                            <td>${c.name}</td>
                            <td><img src="${c.image}" width="50px" height="50px" alt="alt"/></td>
                            <td>${c.price}$</td>
                            <td>${c.description}</td>
                            <td>${dao.getCategoryByID(c.cateID).getCname()}</td>
                            <td>
                                <a href="update?id=${c.id}"><i class="material-icons" data-toggle="tooltip">&#xE254;</i></a>
                                <a href="#" onclick="doDelete('${c.id}')" ><i class="material-icons" data-toggle="tooltip">&#xE872;</i></a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
