                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            <h4 class="card-title card-title-dash">Quote</h4>
                                        </div>
                                        <div>
                                            <form class="search-form" action="QuoteController?service=searchQuote" method="post">
                                                <input type="text" class="form-control" name="name" placeholder="Search Here" title="Search here">
                                            </form>
                                        </div>
                                        <div>
                                            <a href="QuoteController?service=insertQuote" class="btn btn-primary text-white me-0"><i class="mdi mdi-account-plus"></i> Add new quote</a>
                                        ...
                                        <table class="table table-hover"  id="myTable">
                                            ...
                                            <tbody>
                                                <c:forEach items="${data}" var="q">
                                                    <tr>
                                                        <td>${q.news_id}</td>
                                                        <td>${q.newsgroup_id}</td>
                                                        <td>${q.content}</td>
                                                        <td>${q.author}</td>
                                                        <td ><div class="badge badge-info"> <a href="QuoteController?service=updateQuote&id=${q.news_id}">Update</a></div></td> 
                                                        <td ><div class="badge badge-danger"> <a href="QuoteController?service=deleteQuote&id=${q.news_id}">Delete</a></div></td> 
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
