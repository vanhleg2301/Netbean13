                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        ...
                                        <div>
                                            <form class="search-form" action="AboutUsController?service=searchAboutUs" method="post">
...
<!--                                                    <th>Delete</th>-->
                                            ...
                                            <tbody>
                                                <c:forEach items="${data}" var="a">
                                                    <tr>
                                                        <td>${a.getNews_id()}</td>
                                                        <td>${a.getNewsgroup_id()}</td>
                                                        <td>${a.getTitle()}</td>
                                                        <td><img src="${a.getImage()}" alt="alt"/></td>
                                                        <td>${a.getContent()}</td>
                                                        <td ><div class="badge badge-info"> <a href="AboutUsController?service=updateAboutUs&id=${a.getNews_id()}">Update</a></div></td> 
<!--                                                        <td ><div class="badge badge-danger"> <a href="AboutUsController?service=deleteAboutUs&id=">Delete</a></div></td> -->
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
