...
<!--                                        <div>
                                            <a href="ContactUsController?service=insertContactUs" class="btn btn-primary text-white me-0"><i class="mdi mdi-account-plus"></i>Add new Contact Us</a>
                                            ...
                                            <tbody>
                                                <c:forEach items="${data}" var="d">
                                                    <tr>
                                                        ...
                                                        <td>${d.mailContent}</td>
                                                        <td>${d.contactMail}</td>
                                                        <td>${d.phoneContent}</td>
                                                        <td>${d.contactPhone}</td>
                                                        <td><div class="badge badge-info"><a href="ContactUsController?service=updateContactUs&id=${d.id}">Update</a></div></td>
<!--                                                        <td ><div class="badge badge-danger"><a href="ContactUsController?service=deleteContactUs&id=">Delete</a></div></td> -->
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
