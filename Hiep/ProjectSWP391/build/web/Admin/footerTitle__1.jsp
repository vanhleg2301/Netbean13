                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            ...
                            <div class="collapse" id="tables">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" href="FooterTitleController">FooterTitle</a></li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            <h4 class="card-title card-title-dash">footer title</h4>
                                        </div>
                                            ...
                                            <tbody>
                                                <c:forEach items="${data}" var="d">
                                                    <tr>
                                                        <td>${d.id}</td>
                                                        <td>${d.title_name}</td>
                                                        <td><div class="badge badge-info"><a href="FooterTitleController?service=updateFooterTitle&id=${d.id}">Update</a></div></td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
