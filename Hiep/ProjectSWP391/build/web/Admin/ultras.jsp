                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        ...
                                        <div>
                                            <a href="UltrasController?service=insertUltras" class="btn btn-primary text-white me-0"><i class="mdi mdi-account-plus"></i>Add new Ultras</a>
                                            ...
                                            <tbody>
                                                <c:forEach items="${data}" var="d">
                                                    <tr>
                                                        ...
                                                        <td>${d.urlTitle}</td>
                                                        <td>${d.url}</td>
                                                        <td><div class="badge badge-info"><a href="UltrasController?service=updateUltras&id=${d.id}">Update</a></div></td>
                                                        <td ><div class="badge badge-danger"><a href="UltrasController?service=deleteUltras&id=${d.id}">Delete</a></div></td> 
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
