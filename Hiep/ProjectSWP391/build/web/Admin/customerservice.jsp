                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#tables" aria-expanded="false" aria-controls="tables">
                                <i class="menu-icon mdi mdi-table"></i>
                                <span class="menu-title">Footer Manager</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="collapse" id="tables">
                                <ul class="nav flex-column sub-menu">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            <h4 class="card-title card-title-dash">Customer Service</h4>
                                        </div>
                                        <div>
                                            <a href="CustomerServiceController?service=insertCustomerService" class="btn btn-primary text-white me-0"><i class="mdi mdi-account-plus"></i>Add new Ultras</a>
                                            ...
                                            <tbody>
                                                <c:forEach items="${data}" var="d">
                                                    <tr>
                                                        ...
                                                        <td>${d.urlTitle}</td>
                                                        <td>${d.url}</td>
                                                        <td><div class="badge badge-info"><a href="CustomerServiceController?service=updateCustomerService&id=${d.id}">Update</a></div></td>
                                                        <td ><div class="badge badge-danger"><a href="CustomerServiceController?service=deleteCustomerService&id=${d.id}">Delete</a></div></td> 
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
