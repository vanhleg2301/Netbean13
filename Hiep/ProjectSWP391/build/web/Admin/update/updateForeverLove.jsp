            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        ...
                        <form class="forms-sample" method="post" action="ForeverLoveController">
                            <input type="hidden" name="service" value="updateForeverLove">
                            <c:forEach var="d" items="${data}">
                                <div class="row">
                                    <div class="col-md-6 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Update Forever Love</h4>
                                                <p class="card-description">
                                                    Fill all the bank
                                                </p>
                                                <input type="hidden" name="id" value="${d.id}">
                                                <div class="form-group">
                                                    <label for="feedbackContent">feedbackContent</label> <br>
                                                    <textarea id="inputText"  name="feedbackContent" >${d.feedbackContent}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="facebookUrl">facebookUrl</label>
                                                    <input type="text" class="form-control" name="facebookUrl" id="facebookUrl" value="${d.facebookUrl}" placeholder="facebookUrl">
                                                </div>
                                                <div class="form-group">
                                                    <label for="twitterUrl">twitterUrl</label>
                                                    <input type="text" class="form-control" name="twitterUrl" id="twitterUrl" value="${d.twitterUrl}" placeholder="twitterUrl">
                                                </div>
                                                <div class="form-group">
                                                    <label for="youtubeUrl">youtubeUrl</label>
                                                    <input type="text" class="form-control" name="youtubeUrl" id="youtubeUrl" value="${d.youtubeUrl}" placeholder="youtubeUrl">
                                                </div>
                                                <div class="form-group">
                                                    <label for="behanceUrl">behanceUrl</label>
                                                    <input type="text" class="form-control" name="behanceUrl" id="behanceUrl" value="${d.behanceUrl}" placeholder="behanceUrl">
                                                </div>
