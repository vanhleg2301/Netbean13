            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        ...
                        <form class="forms-sample" method="post" action="CustomerServiceController">
                            <input type="hidden" name="service" value="updateCustomerService">
                            <c:forEach var="d" items="${data}">
                                <div class="row">
                                    <div class="col-md-6 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Update Customer Service</h4>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="urltitle" id="urltitle" value="${d.urlTitle}" placeholder="URL Title">
                                                </div>
                                                <div class="form-group">
                                                    <label for="url">URL</label>
                                                    <input type="text" class="form-control" name="url" id="url" value="${d.url}" placeholder="URL">
                                                </div>
