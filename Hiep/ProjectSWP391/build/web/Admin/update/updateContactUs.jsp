            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        ...
                        <form class="forms-sample" method="post" action="ContactUsController">
                            <input type="hidden" name="service" value="updateContactUs">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="inputText"  name="mailContent" >${d.mailContent}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="contactMail">contact Mail</label>
                                                    <input type="text" class="form-control" name="contactMail" id="contactMail" value="${d.contactMail}" placeholder="contact Mail">
                                                </div>
                                                <div class="form-group">
                                                    <label for="phoneContent">phone Content</label> <br>
                                                    <textarea id="inputText"  name="phoneContent" >${d.phoneContent}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="contactPhone">contact Phone</label>
                                                    <input type="text" class="form-control" name="contactPhone" id="contactPhone" value="${d.contactPhone}" placeholder="URL">
                                                </div>
