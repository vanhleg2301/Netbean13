 ...
 * @author Lenovo
 */
public class UpdatePasswordAdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (password.equals(confirmPassword)) {
            ...
            response.sendRedirect("UpdatePasswordAdminController");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
         request.getRequestDispatcher("Admin/changepasswordforgotpassword.jsp").forward(request, response);
    }
