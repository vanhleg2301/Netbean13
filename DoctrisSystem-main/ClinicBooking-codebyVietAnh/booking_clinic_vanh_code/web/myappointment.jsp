                                        ...
                                        <div class="d-md-flex align-items-center text-center justify-content-between">
                                            <ul class="pagination justify-content-center mb-0 mt-3 mt-sm-0">
                                                <c:forEach begin="${1}" end="${num}" var="i">
                                                    ...
                                                    <!--page là trang người dùng bấm. Nếu page = i thì active sẽ hiện xanh--> 
                                                <!--Ban đầu nó chỉ hiển thị 1 trang, sau đó bấm đến trang 2 thì nó sẽ gọi đến controller để làm như với trang 1-->
                                                </c:forEach>
                                            </ul>
                                        </div>
                                    </div>
